...
import { reduceNoise } from '../../api/services/audioService'; // New service for noise reduction

export default function NoiseClear() {
  ...
  const handleNoiseReduction = async () => {
    ...
    try {
      const data = await reduceNoise(file);
      console.log(data);
  ...
  const handleDownload = () => {
    ...
    link.setAttribute('download', 'noise-cleared-audio.mp3');
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-4">
        ...
        >
          ...
          <h1 className="text-4xl font-extrabold text-center text-gray-900 mb-4 tracking-tight">
            🎧 Noise <span className="text-indigo-600">Clear</span>
          </h1>
          <p className="text-center text-gray-500 mb-8">
            Upload your audio file and remove background noise instantly.
            High-quality, clear, and private audio enhancement.
          </p>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            {downloadUrl && (
              ...
              >
                ⬇️ Download Noise-Cleared Audio
              </button>
            )}
          </div>
        </div>
